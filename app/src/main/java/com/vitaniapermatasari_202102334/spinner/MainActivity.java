package com.vitaniapermatasari_202102334.spinner;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initSpinner1() {
        ...
        buahList.add("Nama Nama Buah");
        buahList.add("Apel");
        buahList.add("Alpukat");
        buahList.add("Anggur");
        buahList.add("Melon");
        buahList.add("Aprikot");
    ...
    private  void initSpinner3() {
        ...
        ganjilList.add("Bilangan Ganjil");
